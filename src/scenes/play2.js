...
export class Play2 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("tilesBelow", "public/assets/images/sky_atlas1.png");
        this.load.image("tilesPlatform1", "public/assets/images/platform_atlas1.png");
    }
    ...
    create() {
        ...
        const tilesetBelow = map.addTilesetImage("sky_atlas1", "tilesBelow");
